...
func ResultAt(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ConfirmStatusEQ(v confirmstatus.Status) predicate.Group {
	vc := v
	return predicate.Group(func(s *sql.Selector) {
...
func ConfirmStatusNEQ(v confirmstatus.Status) predicate.Group {
	vc := v
	return predicate.Group(func(s *sql.Selector) {
...
func ConfirmStatusIn(vs ...confirmstatus.Status) predicate.Group {
...
func ConfirmStatusNotIn(vs ...confirmstatus.Status) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ConfirmStatusIsNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ConfirmStatusNotNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtEQ(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldResultAt), v))
	})
}
...
func ResultAtNEQ(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtIn(vs ...time.Time) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ResultAtNotIn(vs ...time.Time) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ResultAtGT(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtGTE(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtLT(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtLTE(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtIsNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ResultAtNotNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
